...
public class GraphAdjList extends Graph {
	 ...
	 */
	 public List<Integer> getDistance2(int v) {
		 ...
		 final List<Integer> oneHopVertices = getNeighbors(v);
		 final List<Integer> twoHopVertices = new ArrayList<Integer>();

		 for(Integer vertexOne: oneHopVertices)
			 for(Integer vertexTwo : getNeighbors(vertexOne))
//				 if(!twoHopVertices.contains(vertexTwo))
					 twoHopVertices.add(vertexTwo);
